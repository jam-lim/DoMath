function brownian_motion_display ( m, n, x ,sim_type, egg_loc,egg_size)

%*****************************************************************************80
%
%% BROWNIAN_MOTION_DISPLAY displays successive Brownian motion positions.
%
%  This code is a modification of John Burkardt's code so we can plot with
%  egg location and egg size.
%
...
%    
%    Input, String sim_type, Simluation type, Random Walk or Brownian
%    Motion
